...
1. Publish milestone/release Maven artifacts on [Maven Central Repository](https://central.sonatype.com/). Can only be done by Xtext release engineer with the right credentials at sonatype
