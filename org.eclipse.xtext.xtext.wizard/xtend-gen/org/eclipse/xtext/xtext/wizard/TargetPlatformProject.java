...
public class TargetPlatformProject extends ProjectDescriptor {
  ...
  public CharSequence target() {
    ...
    _builder.newLine();
    {
      ...
      if (_isAtLeast_1) {
        _builder.append("\t\t\t");
        _builder.append("<repository location=\"https://download.eclipse.org/releases/2025-06\"/>");
        _builder.newLine();
      } else {
        _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<repository location=\"https://download.eclipse.org/tools/orbit/simrel/orbit-aggregation/2025-06\"/>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</location>");
    _builder.newLine();
